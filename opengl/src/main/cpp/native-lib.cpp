...
Java_com_example_opengl_face_FaceTrack_native_1create(JNIEnv *env, jobject instance, jstring model_,
                                                      jstring seeta_) {
...
Java_com_example_opengl_face_FaceTrack_native_1start(JNIEnv *env, jobject instance, jlong self) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_opengl_face_FaceTrack_native_1stop(JNIEnv *env, jobject instance, jlong self) {
...
Java_com_example_opengl_face_FaceTrack_native_1detector(JNIEnv *env, jobject instance, jlong self,
    ...
    int ret = rects.size();
    if (ret) {
        jclass clazz = env->FindClass("com/example/opengl/face/Face");
